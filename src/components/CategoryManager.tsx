  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md mb-6">
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 mb-4">
        <input
          className="flex-grow p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-sm text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 transition"
          value={newCat}
      ...
      <ul className="space-y-2">
        {categories.map((cat) => (
          ...
          >
            <span className="text-gray-800 dark:text-white text-sm">{cat}</span>
            <button
